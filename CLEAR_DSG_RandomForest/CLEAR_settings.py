...
def init(case_study_input,first,last):
    ...
    first_obs = first
    last_obs = last     # number of observations to analyse in CLEAR test dataset Credit 104, PIMA 115,
    ...
    use_sklearn = True  #  currently this switches the AI model to be evaluated to an sklearn SVM
